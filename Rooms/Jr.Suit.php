...
<h3 class="text-center">Make A Reservation</h3><br><br>
 <div class="row" id = "con">
        <div class="col-md-6 col-sm-3  ">
           ...
           <img src = "p4.jpg" height = "250" width = "350">
	   ...
	   <form class="col-md-5 col-sm-3 form-inline" name="myForm" onsubmit="return validateForm()" method="post" action="../Submit1.php">
	     ...
	     <input type="text"  class="form-control" placeholder="Enter Firstname" name="firstname" required><span style = "color:red" id = "s1"> </span>
		 		
	     <input type="text" class="form-control ml-4" placeholder="Enter Middlename" name="middlename" required><span style = "color:red" id = "s2"> </span>
		 
	     <input type="text" class="form-control" placeholder="Enter Lastname" name="lastname" required><span style = "color:red" id = "s3"> </span>
		 
	     <input type="text" class="form-control ml-4" placeholder="Enter Address" name="address" required><span style = "color:red" id = "s4"> </span>
		 
		  <input type="number" class="form-control" placeholder="Enter Contactno" name="contactno" required><span style = "color:red" id = "s5"> </span>
		 
	     <input type="text" class="form-control ml-4" readonly value="Jr.Suit"  name="rmtyp" required><span style = "color:red" id = "s6"> </span>
		 
		 <input type="text" class="form-control" readonly value="3800" name="amt" required><span style = "color:red" id = "s7"> </span>
		 
	    <input type = "date" class = "form-control ml-4" name = "date" required = "required" /><br><br><span style = "color:red" id = "s8"> </span>
